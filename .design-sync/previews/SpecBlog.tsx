...
// The rest-state glyph is 44x28 css px — legible at native size inside the
// tile, but easy to miss in an otherwise blank card. A 4x detail crop next
