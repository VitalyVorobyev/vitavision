    ...
    return (
        <div style={{ width: 208 }}>
            <a
                ...
                aria-label={`${label} — Generate printable calibration targets`}
...
// The rest-state glyph (a miniature 7x4 checkerboard, 44x28 css px) is easy
// to miss at native size — a 4x detail crop makes the individual squares
// (and the accent cell at row 1, col 4) legible.
