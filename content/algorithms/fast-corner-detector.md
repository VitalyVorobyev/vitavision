...
- Compared with Harris: see [When to choose Harris over FAST](/algorithms/harris-corner-detector#when-to-choose-harris-over-fast) on the Harris page, which hosts the comparison per the older-paper-hosts rule.
