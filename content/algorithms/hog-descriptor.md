...
- The HOG + linear-SVM and HOG + DPM sliding-window pipelines were superseded for general object detection by [Faster R-CNN](/atlas/faster-rcnn), which replaces handcrafted gradient histograms with shared convolutional features and a learned Region Proposal Network.
