...
- The practitioner comparison of SIFT against the Harris corner detector is hosted on the Harris page (Harris 1988 is the older paper). See [harris-corner-detector §When to choose SIFT over Harris](/atlas/harris-corner-detector#when-to-choose-sift-over-harris).
