...
The output bounding box is computed by mapping the four corners of the source image through $H$ and taking the axis-aligned rectangle enclosing the four dehomogenized corner locations.
