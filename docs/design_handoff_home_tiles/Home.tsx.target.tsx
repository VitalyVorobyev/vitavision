// Drop-in target for src/pages/Home.tsx — uses the project's stack.
// Verify imports, class names, and the Link `to=` values against the live repo
// before merging.
            ...
            >
                <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
                    {tiles.map(({ label, href, Spec }) => (
                        ...
                        >
                            {/* Radial brand sweep from top-right */}
                            <span
                                aria-hidden
