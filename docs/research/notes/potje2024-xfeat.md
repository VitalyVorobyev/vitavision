...
- The non-host page (`xfeat`) should carry a single Remarks bullet: "Compared with SuperPoint: see [When to choose SuperPoint over XFeat](/algorithms/models/superpoint#when-to-choose-superpoint-over-xfeat). SuperPoint hosts the comparison as the older paper."
