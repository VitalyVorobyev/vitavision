#!/usr/bin/env python3
"""
SURF pipeline diagram.

Generates a 7-stage pipeline SVG for content/algorithms/surf.md.
Run:  .venv/bin/python py/generate_surf_pipeline.py
"""
...
OUTPUT = REPO_ROOT / "content" / "images" / "surf" / "pipeline.svg"
TITLE = "SURF detect-and-describe pipeline"
DESC = (
    "7-stage pipeline from the integral image through box-filter Hessian-determinant "
    "evaluation, NMS and sub-pixel refinement, Haar-wavelet orientation assignment, "
    "and 64-D descriptor extraction with L2 normalisation and Laplacian-sign indexing."
)
...
def render(stages, output_path: Path, title: str, desc: str, cols: int = COLS) -> None:
    ...
    plt.rcParams["svg.hashsalt"] = "vitavision-surf-pipeline"
...
def main(argv=None) -> None:
    parser = argparse.ArgumentParser(
        description="Generate the SURF detect-and-describe pipeline SVG."
    )
    parser.add_argument(
        "output_path",
        nargs="?",
