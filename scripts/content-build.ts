...
async function main(): Promise<void> {
    ...
    for (const e of algorithmPages) collectPrimary(e.frontmatter);
    for (const e of modelPages) collectPrimary(e.frontmatter);
    for (const e of conceptPages) collectPrimary(e.frontmatter);
