...
export const conceptHtmlLoaders: Record<string, () => Promise<GeneratedHtmlModule>> = {
  ...
  "feed-forward-3d-reconstruction": () => import("./content/concepts/feed-forward-3d-reconstruction.ts"),
  ...
  "knowledge-distillation": () => import("./content/concepts/knowledge-distillation.ts"),
  "monocular-depth-estimation": () => import("./content/concepts/monocular-depth-estimation.ts"),
  "non-maximum-suppression": () => import("./content/concepts/non-maximum-suppression.ts"),
  "normalization": () => import("./content/concepts/normalization.ts"),
  ...
  "positional-encoding": () => import("./content/concepts/positional-encoding.ts"),
  "ransac": () => import("./content/concepts/ransac.ts"),
  "scale-space": () => import("./content/concepts/scale-space.ts"),
  "self-supervised-learning": () => import("./content/concepts/self-supervised-learning.ts"),
  ...
  "transformer": () => import("./content/concepts/transformer.ts"),
